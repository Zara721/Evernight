class KeyboardMenu {
    constructor(config={}) {
        this.options = []; //comes through the updater method
        this.up = null;
        this.down = null;
        this.prevFocus = null;
    ...
    createElement() {
        ...
        this.descriptionElement.innerHTML = (`<p> I'm proving information </p>`);
    ...
    init(container) {
        ...
        this.up = new KeyPressListener("ArrowUp", () => {
            ...
            const prevButton = Array.from(this.element.querySelectorAll("button[data-button]")).reverse().find(element => {
        ...
        this.down = new KeyPressListener("ArrowDown", () => {
            const current = Number(this.prevFocus.getAttribute("data-button"));
            const nextButton = Array.from(this.element.querySelectorAll("button[data-button]")).find(element => {
                return element.dataset.button > current && !element.disabled;
            })
            nextButton?.focus()
        })
